...
@section('title', 'Lowongan Kerja - CDC Polibatam')

@section('content')
<!-- Page Header -->
<section class="bg-gradient-primary text-white py-5">
    <div class="container">
        <h1 class="display-5 fw-bold mb-2">Lowongan Kerja</h1>
        <p class="lead">Temukan peluang karir terbaik untuk masa depan Anda</p>
    </div>
</section>
...
<section class="py-5">
    <div class="container">
                ...
                <form action="{{ route('lowongan-kerja') }}" method="GET">
                    <div class="row g-3">
                        ...
                        <div class="col-md-9 d-flex align-items-end gap-2">
                            ...
                            <a href="{{ route('lowongan-kerja') }}" class="btn btn-outline-secondary">
            ...
            <div class="col-md-6 col-lg-4 mb-4">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <h5 class="card-title fw-bold">{{ Str::limit($job->judul, 50) }}</h5>
                    ...
                    <div class="card-footer bg-white border-top-0">
                        <div class="d-flex justify-content-between align-items-center">
                            <small class="text-muted">
                                <i class="bi bi-calendar me-1"></i>{{ $job->tanggal_berakhir->format('d M Y') }}
                            </small>
                            <small class="text-muted">
        ...
        <div class="alert alert-info">
            <i class="bi bi-info-circle me-2"></i>Tidak ada lowongan kerja yang sesuai dengan kriteria pencarian Anda.
        </div>
        @endif
    </div>
</section>
