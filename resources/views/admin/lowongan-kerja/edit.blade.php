{{-- resources/views/admin/lowongan-kerja/edit.blade.php --}}
...
<div class="container-fluid">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1 class="h3 mb-2 fw-bold text-gradient">
                        <i class="bi bi-pencil me-2"></i>Edit Lowongan Kerja
                    </h1>
    ...
    <!-- Form -->
    <form action="{{ route('admin.lowongan-kerja.update', $lowongan->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('judul') is-invalid @enderror" 
                                   name="judul" value="{{ old('judul', $lowongan->judul) }}" required>
                            @error('judul')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('perusahaan') is-invalid @enderror" 
                                   name="perusahaan" value="{{ old('perusahaan', $lowongan->perusahaan) }}" required>
                            @error('perusahaan')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('deskripsi') is-invalid @enderror" 
                                      name="deskripsi" rows="10" required>{{ old('deskripsi', $lowongan->deskripsi) }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('lokasi') is-invalid @enderror" 
                                   name="lokasi" value="{{ old('lokasi', $lowongan->lokasi) }}" placeholder="Contoh: Jakarta Selatan" required>
                            @error('lokasi')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control @error('email_aplikasi') is-invalid @enderror" 
                                   name="email_aplikasi" value="{{ old('email_aplikasi', $lowongan->email_aplikasi) }}" required>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('gaji_min') is-invalid @enderror" 
                                       name="gaji_min" value="{{ old('gaji_min', $lowongan->gaji_min) }}" min="0" step="100000">
                                @error('gaji_min')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('gaji_max') is-invalid @enderror" 
                                       name="gaji_max" value="{{ old('gaji_max', $lowongan->gaji_max) }}" min="0" step="100000">
                                @error('gaji_max')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="gaji_negotiable" 
                                   id="gaji_negotiable" value="1" {{ old('gaji_negotiable', $lowongan->gaji_negotiable) ? 'checked' : '' }}>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('status') is-invalid @enderror" name="status">
                                ...
                                <option value="0" {{ old('status', $lowongan->status) == '0' ? 'selected' : '' }}>Tidak Aktif</option>
                            </select>
                            @error('status')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control @error('tanggal_berakhir') is-invalid @enderror" 
                                   name="tanggal_berakhir" value="{{ old('tanggal_berakhir', $lowongan->tanggal_berakhir->format('Y-m-d')) }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="mb-2">
                                <img src="{{ $lowongan->gambar_url }}" alt="{{ $lowongan->judul }}" 
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('tipe') is-invalid @enderror" name="tipe" required>
                                ...
                                <option value="full_time" {{ old('tipe', $lowongan->tipe) == 'full_time' ? 'selected' : '' }}>Full Time</option>
                                <option value="part_time" {{ old('tipe', $lowongan->tipe) == 'part_time' ? 'selected' : '' }}>Part Time</option>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('kategori') is-invalid @enderror" name="kategori" required>
                                ...
                                <option value="teknologi" {{ old('kategori', $lowongan->kategori) == 'teknologi' ? 'selected' : '' }}>Teknologi</option>
                                <option value="manufaktur" {{ old('kategori', $lowongan->kategori) == 'manufaktur' ? 'selected' : '' }}>Manufaktur</option>
                                <option value="perdagangan" {{ old('kategori', $lowongan->kategori) == 'perdagangan' ? 'selected' : '' }}>Perdagangan</option>
                                <option value="jasa" {{ old('kategori', $lowongan->kategori) == 'jasa' ? 'selected' : '' }}>Jasa</option>
                                <option value="lainnya" {{ old('kategori', $lowongan->kategori) == 'lainnya' ? 'selected' : '' }}>Lainnya</option>
                            </select>
                            @error('kategori')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <small class="text-muted d-block mb-2">
                            ...
                            Dibuat: {{ $lowongan->created_at->format('d M Y H:i') }}
                        </small>
                        <small class="text-muted d-block mb-2">
                            <i class="bi bi-pencil me-1"></i>
                            Diperbarui: {{ $lowongan->updated_at->format('d M Y H:i') }}
                        </small>
                        <small class="text-muted d-block">
                            <i class="bi bi-eye me-1"></i>
                            Views: {{ $lowongan->views_count }}
                        </small>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <button type="submit" class="btn btn-primary w-100 mb-2">
                            <i class="bi bi-save me-2"></i>Update Lowongan
                        </button>
